...
class C_tabel_c2 extends Omnitags
{
	...
	public function update_profil()
	{
		...
		set_userdata($this->aliases['tabel_c2_field2'], $tabel_c2_field2, 600000);
		set_userdata($this->aliases['tabel_c2_field3'], $tabel_c2_field3, 600000);
	...
	public function ceklogin()
	{
		...
		if ($method3->num_rows() > 0) {
			...
			if (password_verify($tabel_c2_field4, $method4)) {
				...
				set_userdata($this->aliases['tabel_c2_field1'], $tabel_c2_field1, 600000);
				set_userdata($this->aliases['tabel_c2_field2'], $tabel_c2_field2, 600000);
				set_userdata($this->aliases['tabel_c2_field3'], $tabel_c2_field3, 600000);
				set_userdata($this->aliases['tabel_c2_field5'], $tabel_c2_field5, 600000);
				set_userdata($this->aliases['tabel_c2_field6'], $tabel_c2_field6, 600000);
