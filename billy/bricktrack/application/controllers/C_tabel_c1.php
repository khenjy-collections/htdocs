...
class C_tabel_c1 extends Omnitags
{
	...
	public function update_profil()
	{
		...
		set_userdata($this->aliases['tabel_c1_field2'], $tabel_c1_field2, 600000);
		set_userdata($this->aliases['tabel_c1_field3'], $tabel_c1_field3, 600000);
		set_userdata($this->aliases['tabel_c1_field5'], $tabel_c1_field5, 600000);
		set_userdata($this->aliases['tabel_c1_field7'], $tabel_c1_field7, 600000);
	...
	public function ceklogin()
	{
		...
		if ($method1->num_rows() > 0) {
			...
			if (password_verify($param8, $method8)) {
				...
				set_userdata($this->aliases['tabel_c1_field1'], $tabel_c1_field1, 600000);
				set_userdata($this->aliases['tabel_c1_field2'], $tabel_c1_field2, 600000);
				set_userdata($this->aliases['tabel_c1_field3'], $tabel_c1_field3, 600000);
				set_userdata($this->aliases['tabel_c1_field5'], $tabel_c1_field5, 600000);
				set_userdata($this->aliases['tabel_c1_field7'], $tabel_c1_field7, 600000);
