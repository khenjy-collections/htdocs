...
class C_tabel_f2 extends Omnitags
{
	...
	public function tambah()
	{
		...
		$currentTime = substr($currentDateTime, 11, 5);

		if ($this->v_post['tabel_f2_field3'] == date("Y-m-d")) {
			if ($this->v_post['tabel_f2_field4'] < $currentTime) {
				$status = $this->aliases['tabel_f2_field6_value1'];
			} else {
				$status = $this->aliases['tabel_f2_field6_value3'];

			}
		} else {
			$status = $this->aliases['tabel_f2_field6_value2'];
		}
		...
		$data = [
			...
			$this->aliases['tabel_f2_field6'] => $status,
		];
	...
	public function update()
	{
		...
		$data = array(
			...
			$this->aliases['tabel_f2_field6'] => $this->aliases['tabel_f2_field6_value4'],
		);
	...
	public function book()
	{
		...
		$data2 = array(
			...
			$this->aliases['tabel_f2_field4'] => $this->aliases['tabel_f2_field4_value2'],
		);
